---
title: 'Stones Sheep in the Peace Region (OM3)'
subtitle: 'Stress-test OM that models gradual reductions in horn length due to selective harvesting pressure.'
...
Specified Value(s): <span style='color:blue'> -0.05, -0.03</span>

Selective pressures reduce average horn size (as per Douhard et al. 2016).  
...
Specified Value(s): <span style='color:blue'> 65.09, 79.83</span>
...
Specified Value(s): <span style='color:blue'> 10.03, 29.62</span>

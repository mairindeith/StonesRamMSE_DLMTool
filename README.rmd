...
## Stone`s sheep in WMU7-42 (Peace Region of British Columbia, Canada): a Data-Limited Methods Toolkit case study for terrestrial mammal harvests
...
![*Curl of the Stone's sheep horn as an indicator of maturity and legal status. Image from the Ministry of Forests, Lands and Natural Resource Operations, British Columbia.*](FullCurlSpecification.png)
